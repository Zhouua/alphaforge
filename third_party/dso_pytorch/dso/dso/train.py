...
class Trainer:
    def __init__(
        ...
        pool : multiprocessing.Pool or None
            ...
            worker should have its own model instance. If None, a Pool will be
        ...
        if self.debug:
            ...
            def print_var_means():
                for name, param in self.policy.named_parameters():
                    ...
                    print(name, "mean:", val.mean(), "var:", val.var())
        ...
        if hasattr(self.policy_optimizer, "pqt_k"):
            ...
            assert isinstance(self.policy_optimizer, PQTPolicyOptimizer)
    ...
    def run_one_step(self, override=None):
        ...
        if self.early_stopping and self.p_r_best.evaluate.get("success"):
            print(
                f"[{get_duration(start_time)}] Early stopping criteria met; breaking early."
            )
            self.done = True
    ...
    # TODO Rename this here and in `run_one_step`
    def _extracted_from_run_one_step_142(self, programs):
    ...
    def save(self, save_path):
        ...
        state_dict = {
            ...
            "r_best": self.r_best,
            "p_r_best_tokens": (
                self.p_r_best.tokens.tolist() if self.p_r_best is not None else None
            ),
        }
