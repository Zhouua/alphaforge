...
# Numba is an optional acceleration only. Use the deterministic Python
# implementation so the shared Python 3.11 environment never has to reconcile
# Numba's NumPy constraints with Qlib/RD-Agent.
